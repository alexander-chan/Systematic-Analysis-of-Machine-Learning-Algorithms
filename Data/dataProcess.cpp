...
int main( int argc, char** argv )
{
	...
	string g0 = "alex_game_06252015_1.txt";
	string g1 = "alex_game_06252015_2.txt";
	string g2 = "alex_game_06292015_2.txt";
	string g3 = "alex_game_06302015_1.txt";
	string g4 = "alex_game_06302015_2.txt";
	
	string i0 = "alex_idle_062315_1.txt";
	string i1 = "alex_idle_06232015_2.txt";
	string i2 = "alex_idle_06242015_1.txt";
	string i3 = "alex_idle_06252015_1.txt";
	string i4 = "alex_idle_06252015_2.txt";
	string i5 = "alex_idle_06292015_2.txt";
	string i6 = "alex_idle_06302015_1.txt";
	string i7 = "alex_idle_06302015_2.txt";
	
	string p = "MathMult/";
	
	gameFiles.push_back("MathMult/" + g0);
	gameFiles.push_back("MathMult/" + g1);
	gameFiles.push_back("MathMult/" + g2);
	gameFiles.push_back("MathMult/" + g3);
	gameFiles.push_back("MathMult/" + g4);

	
	vector<string> idleFiles;
	
	idleFiles.push_back(p + i0);
	idleFiles.push_back(p + i1);
	idleFiles.push_back(p + i2);
	idleFiles.push_back(p + i3);
	idleFiles.push_back(p + i4);
	idleFiles.push_back(p + i5);
	idleFiles.push_back(p + i6);
	idleFiles.push_back(p + i7);
